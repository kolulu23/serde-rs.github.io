...
- ##### `#[serde(tag = "type")]` {#tag}
  ...
  tag. See [enum representations](../examples/enum-representations.md) for details on this
  representation.
...
- ##### `#[serde(tag = "t", content = "c")]` {#tag--content}
  ...
  representations](../examples/enum-representations.md) for details on this representation.
...
- ##### `#[serde(remote = "...")]` {#remote}
  ...
  types](../examples/remote-derive.md).
