...
- ##### `#[serde(rename = "name")]` {#rename}
  ...
  name. This is useful for [serializing fields as camelCase](../examples/attr-rename.md) or
...
- ##### `#[serde(flatten)]` {#flatten}
  ...
  with arbitrary string keys. The [struct flattening](../examples/attr-flatten.md) page
...
- ##### `#[serde(getter = "...")]` {#getter}
  ...
  This is used when deriving `Serialize` for a [remote type](../examples/remote-derive.md)
